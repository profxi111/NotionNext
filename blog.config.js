...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'HeoWeb-main', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '偷偷C出全宇宙', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '纯纯一个复制人', // 作者简介
